...
class TumorGrowthChart extends StatelessWidget {
  final List<CohortSeries> data;

  const TumorGrowthChart({super.key, required this.data});
  ...
  Widget build(BuildContext context) {
    if (data.isEmpty || data.every((c) => c.series.isEmpty)) {
      return const Center(child: Text('No tumor growth data'));
    }
    ...
    return Column(
      ...
      children: [
        const Padding(
          ...
          child: Text('Tumor Growth (mean \u00b1 SEM)', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
        ),
        SizedBox(
          height: 220,
          child: LineChart(
            LineChartData(
              ...
              titlesData: FlTitlesData(
                ...
                leftTitles: AxisTitles(
                  axisNameWidget: const Text('Volume (mm³)', style: TextStyle(fontSize: 12)),
